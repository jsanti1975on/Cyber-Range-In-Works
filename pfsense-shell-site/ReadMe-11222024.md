...
class CustomHTTPRequestHandler(SimpleHTTPRequestHandler):
    ...
    def execute_pfsense_command(self, command):
        hostname = "10.10.10.4"  # Replace with pfSense IP address
        port = 2222  # SSH port for pfSense
        username = "admin"  # Replace with pfSense SSH username
        key_file = "/home/dubz/.ssh/id_rsa"  # Full path to private key
